...
<div class="min-h-screen flex items-center justify-center relative px-4 py-32 overflow-hidden">
    ...
    <!-- Register Card -->
    <div class="relative z-10 w-full max-w-xl bg-black/70 backdrop-blur-xl border border-white/10 rounded-2xl p-8 md:p-12 shadow-2xl">
        ...
        <form action="${pageContext.request.contextPath}/register" method="post" class="space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label class="block text-xs font-bold text-gray-400 uppercase tracking-widest mb-1.5 ml-1">Nom</label>
                ...
                <div>
                    <label class="block text-xs font-bold text-gray-400 uppercase tracking-widest mb-1.5 ml-1">Prénom</label>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label class="block text-xs font-bold text-gray-400 uppercase tracking-widest mb-1.5 ml-1">Mot de passe</label>
                    <input type="password" name="motDePasse" required
                           class="w-full bg-netflix-lightGray/50 border border-white/5 rounded-lg py-3 px-4 text-white focus:outline-none focus:ring-2 focus:ring-netflix-red focus:bg-netflix-lightGray transition-all"
                           placeholder="••••••••">
                </div>
                <div>
                    <label class="block text-xs font-bold text-gray-400 uppercase tracking-widest mb-1.5 ml-1">Confirmer</label>
        ...
        <div class="mt-10 pt-8 border-t border-white/5 text-center">
            <p class="text-gray-500 text-sm">
                Déjà membre ? 
                <a href="${pageContext.request.contextPath}/login" class="text-white font-bold hover:underline transition-all">Connectez-vous</a>.
            </p>
        </div>
    </div>
</div>
