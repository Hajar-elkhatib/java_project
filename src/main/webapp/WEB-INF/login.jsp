<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    <%@ include file="includes/header.jspf" %>
        <div class="min-h-screen flex items-center justify-center relative px-4 py-32 overflow-hidden">
            ...
            <!-- Login Card -->
            <div
                class="relative z-10 w-full max-w-md bg-black/70 backdrop-blur-xl border border-white/10 rounded-2xl p-8 md:p-12 shadow-2xl">
                ...
                <c:if test="${not empty param.success}">
                    <div
                        class="mb-6 bg-green-500/10 border border-green-500/50 text-green-500 text-sm p-4 rounded-lg flex items-center gap-3">
                ...
                <form action="${pageContext.request.contextPath}/login" method="post" class="space-y-6">
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-1.5 ml-1">
                            <label class="text-xs font-bold text-gray-400 uppercase tracking-widest">Mot de
                                passe</label>
                            <a href="#" class="text-[10px] text-gray-500 hover:text-white transition-colors">Oublié
                                ?</a>
                        </div>
                ...
                <div class="mt-10 pt-8 border-t border-white/5 text-center">
                    <p class="text-gray-500 text-sm">
                        ...
                        <a href="${pageContext.request.contextPath}/register"
                            class="text-white font-bold hover:underline transition-all">Inscrivez-vous maintenant</a>.
                    </p>
                </div>
            </div>
        </div>
